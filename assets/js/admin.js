...
const ADMIN = {
  ...
  async registrarArchivo() {
    ...
    var ext    = getExtension(file.name);
    var ruta   = 'assets/uploads/cursos/' + cursoId + '/semana-' + semana + '/' + file.name;
    var self   = this;
    ...
    if (file.size <= LIMITE_FULL) {
      ...
      TOAST.show(
        ...
        'Para verlo siempre, copia el archivo físicamente a: assets/uploads/cursos/' + cursoId + '/semana-' + semana + '/',
        'info', 10000
      );
